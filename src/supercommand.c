...
void execute_command_line(int argc, char *argv[]) {
    ...
    if (mode == 1) { // File Operations
        if (operation == 1 && argc >= 5) { // Create or Open File
            filename = argv[4];
            create_or_open_file(filename);
        } else if (operation == 2 && argc >= 6) { // Change File Permissions
            filename = argv[4];
            permissions = argv[5];
            change_file_permissions(filename, permissions);
        } else if (operation == 3 && argc >= 5) { // Read File
            filename = argv[4];
            read_file(filename);
        } else if (operation == 4 && argc >= 5) { // Write File
            filename = argv[4];
            write_file(filename);
        } else if (operation == 5 && argc >= 5) { // Delete File
            filename = argv[4];
        ...
        if (operation == 1 && argc >= 5) { // Create Directory
            dirname = argv[4];
            create_directory(dirname);
        } else if (operation == 2 && argc >= 5) { // Delete Directory
            dirname = argv[4];
            delete_directory(dirname);
        } else if (operation == 3) { // Print Current Directory
            print_current_directory();
        } else if (operation == 4) { // List Directory
